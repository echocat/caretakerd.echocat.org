...
export class Router {
   ...
   public onDownload: (request: Request, env: Environment, release: string, file: string) => Promise<Response> = async (
      request,
      env,
      release,
      file,
   ...
   public onLatestInfo: (request: Request, env: Environment, type: string) => Promise<Response> = async (
      request,
      env,
      type,
   ) => {
   ...
   public onDocument: (request: Request, env: Environment, type: string) => Promise<Response> = async (
      request,
      env,
      release,
   ) => {
